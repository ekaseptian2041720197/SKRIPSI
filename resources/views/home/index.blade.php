...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="/form" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Login<i
    ...
    <div class="container-fluid bg-light overflow-hidden my-5 px-lg-0">
        <div class="container about px-lg-0">
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0 wow fadeIn" data-wow-delay="0.1s" style="min-height: 900px;">
                    <div class="position-relative h-10">
                        <img class="position-absolute img-fluid w-10 h-10" src="assets/img/logo Paud.jpg"
